            ...
            {movies.map((movie, index) => (
              <tr key={index}>
                ...
                <td>
                  ...
                  <button type="button" data-bs-toggle="modal" data-bs-target='#editModal' className='btn-edit' 
                  ...
                  <button type='button' className='btn-schedule'  data-bs-toggle='modal' data-bs-target='#scheduleModal'  data-id={movie.id}> <ion-icon className='icon-ac-add' name='add-circle-outline'></ion-icon></button>
                </td>
              </tr>
            ))}
